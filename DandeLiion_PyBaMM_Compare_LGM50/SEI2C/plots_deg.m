...
% Porosity
porosity_D125e20_dande = importdata( '1.5buildD1.25e-20/porosity_liquid.dat');
porosity_D75e21_dande = importdata( '1.5buildD7.5e-21/porosity_liquid.dat');
porosity_D25e21_dande = importdata( '1.5buildD25e-21/porosity_liquid.dat');
porosity_D25e22_dande = importdata( '1.5buildD25e-22/porosity_liquid.dat');
% SEI thickness
LSEI_D125e20_dande = importdata( '1.5buildD1.25e-20/SEI_thickness.dat');
LSEI_D75e21_dande = importdata( '1.5buildD7.5e-21/SEI_thickness.dat');
LSEI_D25e21_dande = importdata( '1.5buildD25e-21/SEI_thickness.dat');
LSEI_D25e22_dande = importdata( '1.5buildD25e-22/SEI_thickness.dat');

% Total capacity
cap_D125e20_dande = importdata( '1.5buildD1.25e-20/capacity.dat');
cap_D75e21_dande = importdata( '1.5buildD7.5e-21/capacity.dat');
cap_D25e21_dande = importdata( '1.5buildD25e-21/capacity.dat');
cap_D25e22_dande = importdata( '1.5buildD25e-22/capacity.dat');
% Total capacity
voltage_D125e20_dande = importdata( '1.5buildD1.25e-20/total_voltage.dat');
voltage_D75e21_dande = importdata( '1.5buildD7.5e-21/total_voltage.dat');
voltage_D25e21_dande = importdata( '1.5buildD25e-21/total_voltage.dat');
voltage_D25e22_dande = importdata( '1.5buildD25e-22/total_voltage.dat');
...
figure('Name','Discharge Capacity')
% Simon's paper plot
ploot(SEI_D25e22.data(:,8)*60*60, SEI_D25e22.data(:,4),'b','', 'Time [Min]','')
ploot(SEI_D25e21.data(:,8)*60*60, SEI_D25e21.data(:,4),'r','', 'Time [Min]','')
ploot(SEI_D75e21.data(:,8)*60*60, SEI_D75e21.data(:,4),'m','', 'Time [Min]','')
ploot(SEI_D125e20.data(:,8)*60*60, SEI_D125e20.data(:,4),'k','', 'Time [Min]','')
legend('Pybamm D25e22','Pybamm D25e21','Pybamm D75e21','Pybamm D125e20')
