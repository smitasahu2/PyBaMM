...
for i =[2.5e-22, 2.5e-21,7.5e-21, 1.25e-20]
    ...
    plot(SEI.data(:,1), SEI.data(:,3),'-x','LineWidth',1.5,'MarkerSize',1,'DisplayName', ['D=' num2str(i)]);
    clear
end
...
for i =[2.5e-22, 2.5e-21,7.5e-21, 1.25e-20]
    ...
    plot(SEI.data(:,1), LSEI(1,:)/1e-9,'-x','LineWidth',1.5,'MarkerSize',1,'DisplayName', ['i=' num2str(i)]);
    clear
end
xlabel('Time [hrs]','Interpreter','latex','fontsize',12);
