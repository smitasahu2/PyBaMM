...
# From here we added parameters and input for Phase-change

def lico2_ocp_Dualfoil1998(c_s_rav, c_s_max):
    # """
    ...
    om = 3.5
    # equation 13
    mu_Li = pybamm.constants.R * pybamm.constants.T* (pybamm.log(c_s_rav/c_s_max)/ (1-c_s_rav/c_s_max)+ om (1-2*c_s_rav/c_s_max))
    mu_Li_plus = 0.5
    mu_e_0 = 1
...
def lico2_electrolyte_exchange_current_density_Dualfoil1998(c_e, c_s_rav, c_s_max):
    # """
    ...
    return k* pybamm.exp(mu_Li/ pybamm.R/pybamm.T/2) * c_e**0.5
